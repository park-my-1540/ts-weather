                ...
                <Swiper>
                  {weatherItem.forecastArray.list.map((item, index) => (
                    <div className={weatherIcon} key={index}>
                      <IconText
                        icon={setWeatherIcon(item.weather[0].main)}
                        color="accent"
                        fontSize="26px"
                      />
                      <Text
                        ...
                        style={{ padding: '8px 0' }}
                      >
                        {convertTo12HourFormat(item.dt_txt)}
                        <br />
                        {item.weather[0].main}
                      </Text>
                    </div>
